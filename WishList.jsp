...
String sql="select ad.bid, ad.booktitle, ad.booksubtitle, ad.authorname, ad.photopath, ad.quantity, ad.description, ad.price, ad.discount, w.bid, w.cid from addbook as ad inner join wishlist as w on ad.bid=w.bid where w.cid=?";
								...
								<table class="table">
									...
									%>	
										<tr>
											...
											<td class="pro-remove"><a href="RemoveFromWishlist.jsp?bid=<%=rs.getString(1)%>&cid=<%=cid%>"><i class="far fa-trash-alt"></i></a></td>
											<td>View Book<br>Details</td>
										</tr>
										<%} %>
									</tbody>
								</table>
